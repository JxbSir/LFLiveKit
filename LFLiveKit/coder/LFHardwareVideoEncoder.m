...
- (void)resetCompressionSession {
    ...
    if ([_configuration.profileLevel isEqualToString:@"base"]) {
        VTSessionSetProperty(compressionSession, kVTCompressionPropertyKey_ProfileLevel, kVTProfileLevel_H264_Baseline_AutoLevel);
    } else if ([_configuration.profileLevel isEqualToString:@"main"]) {
        VTSessionSetProperty(compressionSession, kVTCompressionPropertyKey_ProfileLevel, kVTProfileLevel_H264_Main_AutoLevel);
    } else if ([_configuration.profileLevel isEqualToString:@"hight"]) {
