//
//  XBHardwareH265VideoEncoder.m
//

#import "XBHardwareH265VideoEncoder.h"
#import <VideoToolbox/VideoToolbox.h>

@interface XBHardwareH265VideoEncoder (){
...
@property (nonatomic, weak) id<LFVideoEncodingDelegate> h265Delegate;
@property (nonatomic) NSInteger currentVideoBitRate;
@property (nonatomic) BOOL isBackGround;

@end

@implementation XBHardwareH265VideoEncoder
...
- (void)resetCompressionSession {
    ...
    OSStatus status = VTCompressionSessionCreate(NULL, _configuration.videoSize.width, _configuration.videoSize.height, kCMVideoCodecType_HEVC, NULL, NULL, NULL, VideoCompressonOutputCallback, (__bridge void *)self, &compressionSession);
    if (status != noErr) {
        return;
    }
...
static void VideoCompressonOutputCallback(void *VTref, void *VTFrameRef, OSStatus status, VTEncodeInfoFlags infoFlags, CMSampleBufferRef sampleBuffer){
    ...
    XBHardwareH265VideoEncoder *videoEncoder = (__bridge XBHardwareH265VideoEncoder *)VTref;
    if (status != noErr) {
        return;
    }
    ...
    if (statusCodeRet == noErr) {
        ...
        while (bufferOffset < totalLength - AVCCHeaderLength) {
            ...
            if (videoEncoder.h265Delegate && [videoEncoder.h265Delegate respondsToSelector:@selector(videoEncoder:videoFrame:)]) {
                [videoEncoder.h265Delegate videoEncoder:videoEncoder videoFrame:videoFrame];
            }
...
- (void)initForFilePath {
    NSString *path = [self GetFilePathByfileName:@"IOSCamDemo.h265"];
    NSLog(@"%@", path);
